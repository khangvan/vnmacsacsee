...
GO
CREATE PROCEDURE [dbo].[ame_GetFFbyCriteria_WebClient]
...
@strFru varchar(80),
@strAction varchar(80),
@strOrigin varchar(80),
@test varchar(80),
@line varchar(80),
@station varchar(80),
@onlyuntouched int,
...
begin
   ...
   set @legacysql = @legacysql + @strFru
end
...
begin
   ...
   set @sql = @sql +  @strAction
   set @legacysql = @legacysql + ' and RAN_RepairAction_ID = ' 
   set @legacysql = @legacysql +  @strAction
end
...
begin
   ...
   set @sql = @sql +   @strOrigin
   set @legacysql = @legacysql + ' and  OCD_ID = '
   set @legacysql = @legacysql +   @strOrigin
end
