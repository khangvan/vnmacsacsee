...
SET ANSI_NULLS OFF
GO
CREATE PROCEDURE [dbo].[ame_GetFFbyLine]
@line varchar(80),
@rvalue int OUTPUT
AS
...
inner join Stations on FLG_Station= Station_Name
inner join MfgLine on MfgLine.MLN_MfgLine_ID = Stations.STN_MfgLine_ID
WHERE MfgLine.MLN_MfgLine = @line
order by FLG_FailureLogDate
