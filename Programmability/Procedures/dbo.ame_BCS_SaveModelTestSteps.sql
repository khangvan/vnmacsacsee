...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[ame_BCS_SaveModelTestSteps](
	...
	@Limits dbo.SubtestLimitsRecords READONLY,
...
--	select STEP_Name, STEP_Type,STEP_Test_ID,3,STEP_ORDER from @Steps
	...
	begin
		...
		ACSEEMode, SPCParm, Hard_UL, Hard_LL, Limit_Date, ProductGroup_Mask, OpportunitiesforFail,flgForFailure,flgFirstOnly )
		select @id, station_name, subtest_name,SAP_Model,
		@modelid,Limit_Type, UL,LL,strLimit,flgLimit,Units,Description, Author,
		ACSEEMode,SPCParm,Hard_UL,Hard_LL,GETDATE(),0,0,flgForFailure,flgForFirst
