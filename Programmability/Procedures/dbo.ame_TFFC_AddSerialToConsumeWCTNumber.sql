...
SET ANSI_NULLS OFF
GO
CREATE PROCEDURE [dbo].[ame_TFFC_AddSerialToConsumeWCTNumber]
@serial char(20),
@material char(20),
@description char(50),
@ProdOrder nchar(20),
...
TFFC_Material, TFFC_Description, TFFC_Period, TFFC_PrintOnDemand, CTNumber
)
values
(
@ProdOrder, @serial, @insertdate,0,'',0,
@material,@description, @Period, @PrintOnDemand, @CTNumber
)
end
