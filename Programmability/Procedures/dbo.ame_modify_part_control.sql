...
SET ANSI_NULLS ON
GO
CREATE proc [dbo].[ame_modify_part_control]
...
AS
	...
	Begin Transaction
		...
		exec ame_get_part_control_arg @sname, @pname, @menun OUTPUT, @autom OUTPUT, @getsn OUTPUT,
