...
SET ANSI_NULLS OFF
GO
CREATE proc [dbo].[ame_PRT_get_BOM_Level_Station]
...
begin
   delete from PRT_BOM_Level_Station where station=@sname and SAP_Model=@mname and Part_Number in ( '4-3926-01')
end
...
begin
   insert into PRT_BOM_Level_Station ( Station, SAP_Model,Part_Number, Rev,Description, BOM_Date_time, ACSEEMode, Qnty, BOMLevel)
...
begin
   if exists (select station from PRT_BOM_Level_Station where Station = @sname and @mname = 'QS65B-5110001'  and part_number = '5-2510-02' )
   begin
        delete PRT_BOM_Level_Station
...
if  exists ( select BOMLevel from PRT_BOM_Level_Station where station = @sname and SAP_Model= @mname and 
...
if  @sname = 'ACSMAMOUNT' and substring(@mname,1,3) in ('812','822','108','205')
	begin
		update PRT_BOM_Level_Station set Qnty = 2
...
if  @sname = 'ACSMAMOUNT' and substring(@mname,1,3) in ('811','821','109','206')
	begin
		update PRT_BOM_Level_Station set Qnty = 1
...
if exists(select BOMLevel from PRT_BOM_Level_Station where Station=@sname and SAP_Model=@mname and Part_Number='3-0530-16')
  begin
	delete PRT_BOM_Level_Station
	   where Station=@sname and SAP_Model=@mname and Part_Number in ('3-0530-06','3-0530-04','3-0530-02')
  end

if exists(select BOMLevel from PRT_BOM_Level_Station where Station=@sname and SAP_Model=@mname and Part_Number='3-0530-14')
  begin
	delete PRT_BOM_Level_Station
	   where Station=@sname and SAP_Model=@mname and Part_Number in ('3-0530-06','3-0530-04','3-0530-02')
  end
if exists(select BOMLevel from PRT_BOM_Level_Station where Station=@sname and SAP_Model=@mname and Part_Number='3-0530-12')
  begin
	delete PRT_BOM_Level_Station
	   where Station=@sname and SAP_Model=@mname and Part_Number in ('3-0530-06','3-0530-04','3-0530-02')
  end
if exists(select BOMLevel from PRT_BOM_Level_Station where Station=@sname and SAP_Model=@mname and Part_Number='3-0530-10')
  begin
	delete PRT_BOM_Level_Station
	   where Station=@sname and SAP_Model=@mname and Part_Number in ('3-0530-06','3-0530-04','3-0530-02')
  end
...
if exists(select BOMLevel from PRT_BOM_Level_Station where Station=@sname and @sname='ACS4410BACK' and SAP_Model=@mname and SAP_Model in ('F42-14236',
...
if exists(select BOMLevel from PRT_BOM_Level_Station where Station=@sname  and SAP_Model=@mname and SAP_Model = 'F42-14221')
  begin
	delete PRT_BOM_Level_Station
	   where Station=@sname and SAP_Model=@mname and Part_Number in ('3-0622-02' )
  end

if exists(select BOMLevel from PRT_BOM_Level_Station where Station=@sname and @sname = 'ACS4410BACK' and SAP_Model=@mname and Part_Number='3-0530-08')
  begin
	delete PRT_BOM_Level_Station 	   where Station=@sname and SAP_Model=@mname and Part_Number in ('3-0530-06','3-0530-04','3-0530-02')
  end
...
begin
if   exists(select * from PRT_BOM_Level_Station where station='ViperStart' and part_number='5-1885' )
begin
   insert PRT_BOM_Level_Station (Station, SAP_Model, Part_Number, Rev, Description, BOM_Date_Time, ACSEEMode, Qnty, BOMLevel) 
select Station, SAP_Model, Part_Number, Rev, Description, BOM_Date_Time, ACSEEMode, Qnty, BOMLevel from PRT_BOM_Level_Station 
...
begin
   delete from PRT_BOM_Level_Station where station=@sname and SAP_Model=@mname and Part_Number in ( '3-0622-02')
end

--if   exists(select BOMLevel from PRT_BOM_Level_Station where @sname='ViperStart'  and SAP_Model=@mname and sap_model like '5-2350-%' and station='ViperStart')
--begin
--   insert PRT_BOM_Level_Station select * from PRT_BOM_Level_Station where station='ViperStart'
--end



if exists(select BOMLevel from PRT_BOM_Level_Station where Station=@sname and SAP_Model=@mname and Part_Number='3-0504-16')
  begin
	delete PRT_BOM_Level_Station
	   where Station=@sname and SAP_Model=@mname and Part_Number in ('3-0504-06','3-0504-04','3-0504-02')
  end
if exists(select BOMLevel from PRT_BOM_Level_Station where Station=@sname and SAP_Model=@mname and Part_Number='3-0504-14')
  begin
	delete PRT_BOM_Level_Station
	   where Station=@sname and SAP_Model=@mname and Part_Number in ('3-0504-06','3-0504-04','3-0504-02')
  end
if exists(select BOMLevel from PRT_BOM_Level_Station where Station=@sname and SAP_Model=@mname and Part_Number='3-0504-12')
  begin
	delete PRT_BOM_Level_Station
	   where Station=@sname and SAP_Model=@mname and Part_Number in ('3-0504-06','3-0504-04','3-0504-02')
  end
if exists(select BOMLevel from PRT_BOM_Level_Station where Station=@sname and SAP_Model=@mname and Part_Number='3-0504-10')
  begin
	delete PRT_BOM_Level_Station
	   where Station=@sname and SAP_Model=@mname and Part_Number in ('3-0504-06','3-0504-04','3-0504-02')
  end

if exists(select BOMLevel from PRT_BOM_Level_Station where Station=@sname and SAP_Model=@mname and Part_Number='3-0504-08')
  begin
	delete PRT_BOM_Level_Station
	   where Station=@sname and SAP_Model=@mname and Part_Number in ('3-0504-06','3-0504-04','3-0504-02')
  end

if exists(select BOMLevel from PRT_BOM_Level_Station where Station=@sname and SAP_Model=@mname and Part_Number='3-0521-22')
  begin
	delete PRT_BOM_Level_Station
	   where Station=@sname and SAP_Model=@mname and Part_Number in ('3-0521-06','3-0521-04','3-0521-02')
  end
if exists(select BOMLevel from PRT_BOM_Level_Station where Station=@sname and SAP_Model=@mname and Part_Number='3-0521-24')
  begin
	delete PRT_BOM_Level_Station
	   where Station=@sname and SAP_Model=@mname and Part_Number in ('3-0521-06','3-0521-04','3-0521-02')
  end

if exists(select BOMLevel from PRT_BOM_Level_Station where Station=@sname and SAP_Model=@mname and Part_Number='3-0521-26')
  begin
	delete PRT_BOM_Level_Station
	   where Station=@sname and SAP_Model=@mname and Part_Number in ('3-0521-06','3-0521-04','3-0521-02')
  end

if exists(select BOMLevel from PRT_BOM_Level_Station where Station=@sname and SAP_Model=@mname and Part_Number='3-0521-34')
  begin
	delete PRT_BOM_Level_Station
	   where Station=@sname and SAP_Model=@mname and Part_Number in ('3-0521-06','3-0521-04','3-0521-02')
  end

if exists(select BOMLevel from PRT_BOM_Level_Station where Station=@sname and SAP_Model=@mname and Part_Number='3-0542-24')
  begin
	delete PRT_BOM_Level_Station
	   where Station=@sname and SAP_Model=@mname and Part_Number in ('3-0542-06','3-0542-04','3-0542-02')
  end

if exists(select BOMLevel from PRT_BOM_Level_Station where Station=@sname and SAP_Model=@mname and Part_Number='3-0542-06')
  begin
	delete PRT_BOM_Level_Station
...
if exists(select BOMLevel from PRT_BOM_Level_Station where Station=@sname and SAP_Model=@mname and Part_Number='664415-001005-0000')
  begin
	delete PRT_BOM_Level_Station
...
-- FFC BOM override
if exists(select BOMLevel from PRT_BOM_Level_Station where Station=@sname and SAP_Model=@mname and Part_Number in ('QS6-0000','QS6-0100',
...
-- WDK 090605
if exists ( select BOMLevel from PRT_BOM_Level_Station where Station = @sname and SAP_Model=@mname and Part_Number in ( '7-0204'))
  begin
     delete PRT_BOM_Level_Station
...
-- or substring(@mname,1,2)='06'
		if substring(@mname,1,2)='PS'
			begin
				if exists(select Part_Number from PRT_BOM_Level_Station where Station=@sname and SAP_Model=@mname 
	   ...
	   select PRT_BOM_Level_Station.SAP_Model,Catalog.Part_No_Name As Part_Number, PRT_BOM_Level_Station.Rev, PRT_BOM_Level_Station.Description,
		PRT_BOM_Level_Station.BOM_Date_Time, Stations.Station_Name As Station,
		Partlist.Get_Serial As Part_Type, PRT_BOM_Level_Station.ACSEEMode, 
                                         PRT_BOM_Level_Station.Part_Type as ACS_Part_Type,
		Partlist.Automatic As Display_Option, 
		Partlist.Disp_Order As Display_Order, MappedFileNames.MappedFileName,PRT_BOM_Level_Station.Qnty,PRT_BOM_Level_Station.BOMLevel 
		...
		Inner join PRT_BOM_Level_Station on PRT_BOM_Level_Station.Part_Number = Catalog.Part_No_Name
		Left Outer Join MappedFileNames on PRT_BOM_Level_Station.Part_Number = MappedFileNames.Part_Number
		where Stations.Station_Name=@sname and PRT_BOM_Level_Station.Station=@sname and 
			PRT_BOM_Level_Station.SAP_Model = @mname 
...
begin
if exists(select BOMLevel from PRT_BOM_Level_Station where Station=@sname and SAP_Model=@mname and (Part_Number in
...
-- end wk
	   	...
	   	select PRT_BOM_Level_Station.SAP_Model,Catalog.Part_No_Name As Part_Number, PRT_BOM_Level_Station.Rev, PRT_BOM_Level_Station.Description,
			PRT_BOM_Level_Station.BOM_Date_Time, Stations.Station_Name As Station,
			Partlist.Get_Serial As Part_Type, PRT_BOM_Level_Station.ACSEEMode, 
			Partlist.Automatic As Display_Option,  			Partlist.Disp_Order As Display_Order, MappedFileNames.MappedFileName,PRT_BOM_Level_Station.Qnty,PRT_BOM_Level_Station.BOMLevel ,
                                         PRT_BOM_Level_Station.Part_Type as ACS_Part_Type
			from Partlist Inner join Catalog
			on Partlist.Part_No = Catalog.Part_No_Count
			Inner join Stations on Partlist.Station = Stations.Station_Count
			...
			where Stations.Station_Name=@sname AND PRT_BOM_Level_Station.Station=@sname and
				PRT_BOM_Level_Station.SAP_Model = @mname 
		union
		select PRT_BOM_Level_Station.SAP_Model,PRT_BOM_Level_Station.Part_Number,PRT_BOM_Level_Station.Rev,PRT_BOM_Level_Station.Description,
			PRT_BOM_Level_Station.BOM_Date_Time, 'Station' as Station,
			'X' as Part_Type, PRT_BOM_Level_Station.ACSEEMode, 
			'A' as Display_Option, '1' as Display_Order,MappedFileNames.MappedFileName,PRT_BOM_Level_Station.Qnty,PRT_BOM_Level_Station.BOMLevel ,
                                          PRT_BOM_Level_Station.Part_Type as ACS_Part_Type
			 from PRT_BOM_Level_Station 			Left Outer Join MappedFileNames on PRT_BOM_Level_Station.Part_Number = MappedFileNames.Part_Number  			where PRT_BOM_Level_Station.Station=@sname and PRT_BOM_Level_Station.SAP_Model = @mname and (  substring(PRT_BOM_Level_Station.Part_Number,1,3) = 'R96' 
			or substring(PRT_BOM_Level_Station.Part_Number,1,4) = 'INFO' 
			or substring(PRT_BOM_Level_Station.Part_Number,1,3) = 'ERS'
			or substring(PRT_BOM_Level_Station.Part_Number,1,3) = 'R56'
			or substring(PRT_BOM_Level_Station.Part_Number,1,3) = 'XBL'
			or substring(PRT_BOM_Level_Station.Part_Number,1,3) = 'X96'
			or substring(PRT_BOM_Level_Station.Part_Number,1,3) = 'XLA'
			or substring(PRT_BOM_Level_Station.Part_Number,1,3) = 'XLB'
			or substring(PRT_BOM_Level_Station.Part_Number,1,3) = 'XHA'
			or substring(PRT_BOM_Level_Station.Part_Number,1,3) = 'XHB'
			or substring(PRT_BOM_Level_Station.Part_Number,1,2) = 'eb'
			or substring(PRT_BOM_Level_Station.Part_Number,1,2) = 'nk'
			or substring(PRT_BOM_Level_Station.Part_Number,1,3) = 'XVA'  )
		return
	 end
