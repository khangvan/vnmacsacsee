...
GO
CREATE PROCEDURE [dbo].[ame_ONESapMarch24FinalCopyParts]
 AS
set nocount on
...
select @newpartnoname = onesapcorrectednewpart , @newpartdescription =onesapnewpartdescription  from OneSAPMarch24FinalTranslateList where onesapoldpart = @partnoname
print @newpartnoname
...
Begin transaction
  ...
  --                           select @lastidentity = @@identity
                             ...
                             insert into onesapcatalog_March24Finaltracker
                             (
                                        onesapcatalog_part_no,
                                        onesapcatalog_partname,
...
--             begin
	...
	select @lastidentity = @@identity
              insert into OneSAPPartList_March24FinalTracker
              (
