CREATE TABLE [dbo].[BOM_Level_Station] (
...
CREATE INDEX [ISAP_Model]
  ON [dbo].[BOM_Level_Station] ([SAP_Model])
  WITH (FILLFACTOR = 80)
  ON [PRIMARY]
GO

CREATE CLUSTERED INDEX [IStation]
  ON [dbo].[BOM_Level_Station] ([Station])
  WITH (FILLFACTOR = 80)
  ON [PRIMARY]
GO